    ...
    <section>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white p-4 rounded shadow">
          <Image src="/images/book1.png" alt="Modern CSS Book" width={300} height={400} />
          <h3 className="mt-3 font-medium">Modern CSS with Tailwind Second Edition</h3>
        </div>

        <div className="bg-white p-4 rounded shadow">
          <Image src="/images/book2.png" alt="The Next.js Handbook" width={300} height={400} />
          <h3 className="mt-3 font-medium">The Next.js Handbook</h3>
        </div>

        <div className="bg-white p-4 rounded shadow">
          <Image src="/images/book3.jpg" alt="Mindset Psychology" width={300} height={400} />
